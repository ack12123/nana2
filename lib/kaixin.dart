...
class KaixinPage extends StatefulWidget {
  const KaixinPage({super.key});

  @override
  KaixinPageState createState() => KaixinPageState();
}

class KaixinPageState extends State<KaixinPage> {
  int _selectedIndex = 0;
  final AudioManager _audioManager = AudioManager();
  final TextEditingController _searchController = TextEditingController();
  List<String> _kaixinFiles = [];
